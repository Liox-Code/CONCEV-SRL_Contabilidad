...
class ModificarFila extends Component {
  constructor(props) {
    super(props);
    var [ingresoNumero, ingresoDecimal] = this.props.route.params.fila.ingresos.toString().split('.');
    var [egresoNumero, egresoDecimal] = this.props.route.params.fila.egresos.toString().split('.');
    
    ingresoNumero = parseFloat(ingresoNumero);
    ingresoDecimal = parseFloat(ingresoDecimal);
    egresoNumero = parseFloat(egresoNumero);
    egresoDecimal = parseFloat(egresoDecimal);
    ...
    this.state = {
        ...
        'descripcion': this.props.route.params.fila.descrpcion,
        'ingreso': this.props.route.params.fila.ingresos,
        'ingresoNumero': ingresoNumero,
        'ingresoDecimal': ingresoDecimal,
        'egreso': this.props.route.params.fila.egresos,
        'egresoNumero': egresoNumero,
        'egresoDecimal': egresoDecimal,
        'saldo': this.props.route.params.fila.saldoFila,
        'otro': this.props.route.params.fila.otros
    }
  }

  componentDidMount() {
    this.props.navigation.setOptions({'title': 'Modificar Fila'});
  }
                        ...
                        <ScrollView>
                            ...
                            <Text style={styles.inputLabel}>
                                ...
                                <Pressable style = {styles.botonGuardar} onPress = {() => this.pasarDatos()}>
                                    <Text style = {styles.textoBotonGuardar}>Modificar</Text>
                                </Pressable>
                        </ScrollView>
                    </View>
                </TouchableWithoutFeedback>
